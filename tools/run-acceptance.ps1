...
param(
  ...
  # Какие пары гонять по Id. Пусто — все. Полный проход это 42 прогона
  # и несколько часов, а приёмка одного раздела — три пары.
  #
...
# Отбор пар. Пар стало семь, сред три, полярности две — это 42 прогона,
# и при таймауте Claude в 900 секунд полный проход занимает часы. Когда
